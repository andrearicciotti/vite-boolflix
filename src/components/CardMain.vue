...
<template>
    ...
    <div class="info">
        ...
        <h3 v-if="media.title"><strong>Titolo : </strong>{{ media.title }}</h3>
        ...
        <p class="caption" v-if="media.overview"><strong>Descrizione : </strong>{{ media.overview }}</p>
        <img :src="handleImgPath(media.backdrop_path)" :alt="media.title ? media.title : media.original_name">
